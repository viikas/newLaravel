...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'role' => 'Modules\Quotes\Http\Middleware\TokenEntrustRole',
        'permission' => 'Modules\Quotes\Http\Middleware\TokenEntrustPermission',
        'ability' => 'Modules\Quotes\Http\Middleware\TokenEntrustAbility'
